<!-- patient profile edit page for admin -->
<?php 
    session_start();
    include('header.php'); //header
    include('php_connection.php'); //db connection
    $var = $_GET['id'];
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="php_patient_profile_update.php" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 ">
                                    <input type="text" id="full_name" class="form-control box-bg " name="rid" value="<?php echo $row['pid']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Name</label>
                                    <div class="col-md-6">
                                        <input type="text" id="email_address" class="form-control box-bg" name="name" value="<?php echo $row['pname']; ?>" required>
                                    </div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Address</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="address" value="<?php echo $row['paddress']; ?>"required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">DOB</label>
                                    <div class="col-md-6">
                                        <input type="date"  class="form-control box-bg" name="dob" value="<?php echo $row['pdob']; ?>"required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  name="email" class="form-control box-bg" value="<?php echo $row['pemail']; ?>"required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Mobile</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="mobile" value="<?php echo $row['pmobile']; ?>" required>
                                    </div>
                                </div>
								<div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Password</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control box-bg" value="<?php echo $row['ppassword']; ?>" name="password"required>
                                    </div>
                                </div>
								<div class="form-group row">
